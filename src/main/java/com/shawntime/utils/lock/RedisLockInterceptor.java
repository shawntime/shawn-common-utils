...
import com.shawntime.utils.cache.redis.SpringRedisHelper;
import com.shawntime.utils.lock.spelkey.KeySpELAdviceSupport;
...
public class RedisLockInterceptor extends KeySpELAdviceSupport {
    ...
    @Pointcut("@annotation(com.shawntime.utils.lock.RedisLockable)")
