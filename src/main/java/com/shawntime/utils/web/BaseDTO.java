package com.shawntime.utils.web;

import com.shawntime.utils.helper.TelHelper;
import com.shawntime.utils.web.annotation.AutoValidate;
        ...
        try {
            for (Field f : fields) {
                ...
                if (autoValidate.phone()) {
                    if (obj != null && !TelHelper.isMayBeMobiePhoneNum(String.valueOf(obj))) {
