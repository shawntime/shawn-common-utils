...
public final class CookieHelper {
    ...
    public static int getAbTestValueFromCookie(HttpServletRequest request, HttpServletResponse response, String site,
        ...
        String abtestCookieFlag = CookieHelper.getCookieValueByName(request, cookieName);
        int abtestFlag;
        if (StringUtils.isNotBlank(abtestCookieFlag)) {
            ...
            CookieHelper.addCookie(response, site, cookieName, String.valueOf(abtestFlag), seconds);
        }
        return abtestFlag;
    }
