...
public final class NumberHelper {
    ...
    public static Double parseDouble(String num){
        ...
        return NumberUtils.createDouble(result);
    }
    ...
    public static BigDecimal parseBigDecimal(String num){
        ...
        return NumberUtils.createBigDecimal(result);
    }
    ...
    public static Integer parseInteger(String num){
        ...
        return NumberUtils.createInteger(result);
    }
    ...
    public static Float parseFloat(String num){
        ...
        return NumberUtils.createFloat(result);
    }
}
